...
// --- Minimal GUI (smaller + fewer controls) ---
const pane = new Pane({
...
paneElement.style.top = "12px";
paneElement.style.right = "12px";
paneElement.style.zIndex = "10000";
paneElement.style.backgroundColor = "rgba(0, 0, 0, 0.9)";
paneElement.style.borderRadius = "10px";
...
/* make it smaller + scrollable on mobile */
paneElement.style.transformOrigin = "top right";
paneElement.style.transform = "scale(0.8)";
paneElement.style.maxHeight = "70vh";
...
analogFolder
    .addBinding(params, "limboMode", { label: "Limbo (B/W)" })
    .on("change", (ev) => {
